...
- ĐA DẠNG HÓA NHÂN VẬT (CHARACTER DIVERSITY): Để tránh sự nhàm chán, nếu có nhân vật thì BẮT BUỘC mỗi prompt phải miêu tả một KIỂU NHÂN VẬT HOÀN TOÀN KHÁC NHAU tùy theo ngữ cảnh. Hãy luân phiên sử dụng các từ khóa như: **female, male, older woman, older man** kết hợp với nghề nghiệp hoặc độ tuổi cụ thể. KHÔNG được dùng mãi một kiểu nhân vật mặc định (nữ trẻ tuổi). Tuy nhiên, BẮT BUỘC vẫn phải thêm từ khóa 'Asian' để giữ đúng nét Á Đông.
